    ...
    public class PointsOfInterestController : ControllerBase
    {
        ...
        public IActionResult GetPointsOfInterest(int cityId)
        {
            ...
            catch (Exception ex)
            {
                ...
                return StatusCode(500, $"A problem happened while getting all points of interest for city with id {cityId}.");
            }
        }
            ...
            [FromBody] PointOfInterestForCreationDto pointOfInterest)
        {
            ...
            {
                ModelState.AddModelError("Description", "Description must differ from the name.");
            }
        ...
        public IActionResult PartiallyUpdatePointOfInterest(int cityId, int id, [FromBody] JsonPatchDocument<PointOfInterestForUpdateDto> patchDoc)
        {
            ...
            {
                ModelState.AddModelError("Description", "The description should differ from the name.");
            }
